...
```r
install.packages(c("BiocManager", "dplyr", "msigdbr"))
...
__*G Yu*__, LG Wang, Y Han, QY He. [clusterProfiler: an R package for comparing biological themes among gene clusters](http://dx.doi.org/10.1089/omi.2011.0118. **_OMICS: A Journal of Integrative Biology_** 2012, 16(5):284-287. doi:10.1089/omi.2011.0118
